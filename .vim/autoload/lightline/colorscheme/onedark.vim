...
let s:p.insert.left = [ [ s:black, s:red ], [ s:white, s:grey ] ]  "Change insert colours
let s:p.insert.right = [ [ s:black, s:red ], [ s:white, s:grey ] ]
let s:p.replace.left = [ [ s:black, s:blue ], [ s:white, s:grey ] ]
let s:p.replace.right = [ [ s:black, s:blue ], [ s:white, s:grey ] ]
